...
#         print(x)
#         output.close()
#     return render(request, 'info_app/federalregister.html')

def bls_surveys(request):
    data= requests.get('https://www.federalregister.gov/api/v1/agencies')
    response = data.text
    print(response)

    return (request, "info_app/federalregister.html")